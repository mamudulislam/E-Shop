                ...
                <div className="grid grid-cols-[1fr_2fr] gap-[56px] ml-[110px] mb-20">
                    ...
                    <div className="pr-[110px]">
                        ...
                        <div className="text-lg text-gray-800 leading-8 whitespace-pre-line font-montserrat">
                            ...
                            <h3 className="font-Montserrat font-bold text-[20px] mb-4 mt-8">3C Connectivity</h3>
                            <p className="mb-6 font-Montserrat font-normal text-[20px] leading-[30px] text-black01">
                            ...
                            <h3 className="font-Montserrat font-bold text-[20px] mb-4 mt-8">Aerobic Intelligence (AI)</h3>
                            <p className="mb-6 font-Montserrat font-normal text-[20px] leading-[30px] text-black01">
                            ...
                            <h3 className="font-Montserrat font-bold text-[20px] mb-4 mt-8">Visual Reality (VR) and Augmented Reality (AR)</h3>
                            <p className="mb-6 font-Montserrat font-normal text-[20px] leading-[30px] text-black01">
